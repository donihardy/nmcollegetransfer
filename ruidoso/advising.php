      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="textbody"><h3>ENMU Ruidoso Advising <a href="../questions.php#advising"><img class="question" src="../images/questionmark.png"></a></h3>
            ...
            <p><a href="http://ruidoso.enmu.edu/index.php/new-page/97-advising">ENMU Ruidoso Advising General Info</a></p>
            <h4 id="website">ENMU Advising Website</h4>
            <p><a href="http://ruidoso.enmu.edu/index.php/new-page/97-advising">ENMU Advising Website</a><br />
              <a href="https://www.enmu.edu/services/advising/faq.shtml">FAQs</a></p>
              <h4 id="appt">Schedule an Appointment</h4>
              <p>To contact an academic advisor send email to <a href="mailto:ruidosoadvising@enmu.edu">ruidosoadvising@enmu.edu</a> or <a href="1-575-257-2120">(575) 257-2120</a> to make an appointment.</p>
