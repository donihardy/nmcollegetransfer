        ...
        <tr>
            ...
            <div class="accordian-body collapse" id="enmu"> 
               <table class="table table-striped">
                      <thead>
                        <tr><td class="schoolname" width="20%">Requirements:</td><td class="schoolname" width="20%"">Eligibility:</td><td class="schoolname" width="20%">Deadlines:</td> <td class="schoolname" width="20%">Fees:</td><td class="schoolname" width="20%">Campus Visits:</td></tr>
            ...
            <td colspan="12" class="hiddenRow"><div class="accordian-body collapse" id="iaia"> 
              <table class="table table-striped">
                      <thead>
                        ...
                        <tr><td>Insert Info</td></tr>
                        <tr><td class="schoolname">Military info:<td></tr>
                        <tr><td>Insert Info</td></tr>
                      </thead>
                </table>
              </div> 
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <table class="table table-striped">
                      <thead>
                        ...
                        <td>College GPA of 2.0 for transfer students. High School GPA of 2.5 or ACT of 17 or SAT of 810.</td>
                        <td>30 Days before semester starts.</td>                  
                        <td width="20%">No Fees</td>
                        <td width="20%"><a href="http://www.enmu.edu/admission%20/schedule-your-visit">Campus Visits</a></td>
                        </tr>
                      </thead>
