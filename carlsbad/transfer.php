        ...
        <div class="navbar-header">
          ...
          <div class="container-fluid">
            <div class="textbody">
              ...
              <p>The Office of Student Services assists current and prospective students in completing the admissions process, maintaining current student files and monitoring academic standing. Additionally, student enrollment status is continually updated and unofficial transcripts and academic records are maintained for all past or present students.</p>
              
              <h4 id="transcripts">Transcripts</h4>

              <p>Request official transcripts of high school or GED and all previous college course work. All official transcripts
                should be mailed directly by the school or college registrar to:</p>
                <p>NMSU Carlsbad<br />
                  ATTN: Admissions Office<br />
                  1500 University Drive<br />
                  Carlsbad, NM 88220</p>
                  <p>Official NMSU transcripts can be ordered online at <a href="http://nmsu.edu/~registra/transcripts">http://nmsu.edu/~registra/transcripts</a> or by mail (see <a href="https://carlsbad.nmsu.edu/students/all-students/student-services/">Student Services</a>). An electronic transcript is $10.00 and a paper transcript is $12.25. For questions, contact the NMSU Las Cruces Registrar’s office at (575)646-4990. Official name changes on transcripts will be processed only if a student is currently enrolled and a written request is submitted.</p>
                  <div><h4 id="tes">Transferable Courses</h4>
                    ...
                    <p>Students may satisfy basic skills requirements in English
                      ...
                      options: ENGL 111G or ENGL 111H. Students may satisfy
                      English basic skills by passing ENGL 111G or ENGL 111H
                      with a grade of C or higher</p>
                      <p> Students may satisfy basic skills
                        ...
                        <p><a href="https://dept-wp.nmsu.edu/etse2/files/2014/05/NMSU-CarlsbadCC-to-ECET.pdf">NMSU Engineering Technology Articulation</a><br />
                          ...
                          <p>Eligibility<br />
                            To be eligible for NMSU Carlsbad’s Dual Credit Program, you must:</p>
                            <ul><li>high school junior or senior with a 2.0 or higher cumulative GPA.  Sophomores and students with lower GPAs may be considered on a case by case basis.</li>
                              <li>be enrolled in Artesia, Carlsbad, Loving, and Jefferson Montessori Schools.</li>
