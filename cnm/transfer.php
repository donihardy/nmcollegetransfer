      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="textbody">
            ...
            <p>Visit: <a href="https://www.cnm.edu/depts/recordsretention/documents/request-transcript-from-another-institution">Request transcripts from another institution.</a></p>
            <p>Request transcipts to be sent to another institution from CNM:<br/>
              ...
              <br />Visit: <a href="https://www.cnm.edu/student-resources/academic-records/academic-records-list/transcript-request">Transcript Request</a></p>
              ...
              <p>Credit earned at other post-secondary institutions and / or credit for prior learning may be transferred and applied toward program requirements.<br />
                <p>Visit: <a href="https://www.cnm.edu/student-resources/transfer/transfer-to-cnm">Transfer to CNM</a><br />
                  Visit: <a href="http://tes.collegesource.com/view/tes_view01.asp?rid={0503AFD5-0DB5-454E-A227-CC387FC5A19F}&aid={3953860A-3699-4EFE-A557-7B3E41278DD9}">TES (Transfer Evaluation System)</a></p>
                  <h4 id="commoncore">Common Core Courses</h4>
                  Visit: <a href="../nmcommoncore.html">Common Core Course</a><br/>
                  ...
                  Visit: <a href="https://www.cnm.edu/registration">CNM ACT/SAT</a><br />
                  <h4 id="2+2">2+2 and other Transfer Agreements</h4>
                  Visit: <a href="https://www.cnm.edu/depts/academic-affairs/transfer-agreements">Transfer agreements with other schools</a><br />
                  ...
                  <p>The Dual Credit Program offers free classes* for students in central New Mexico attending a public, private, charter, or home school.
                    ...
                    Visit: <a href="https://www.cnm.edu/depts/outreach/dual-credit/high-school-and-dual-credit-programs">Dual Enrollment</a><br />
                    ...
                    Visit: <a href="https://www.cnm.edu/depts/advisement/contact-advisement">CNM Request Info</a>
                  </div>
                </div>
