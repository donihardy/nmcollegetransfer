...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        <div class="textbody"><h3>Mesalands Advising <a href="../questions.php#questions"><img class="question" src="../images/questionmark.png" alt="question mark image"></a></h3>
          ...
          <p>Visit: <a href="http://www.mesalands.edu/academic-advisement/">Mesalands Advising Website</a></p>
          <h4 id="appt">Schedule an Appointment</h4>
          <p>It is required that first-time, degree-seeking students first visit with an academic advisor before registering for courses. If it is not practical to visit the College, an advisor may be reached by calling <a href="tel:1-575-461-4413">(575) 461-4413, ext. 153</a></p>
          <p>Visit: <a href="http://www.mesalands.edu/current-students/registrationprocess/">Mesalands Advising</a></p>
        </div>
      </div>
