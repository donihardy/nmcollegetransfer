...
<body> <?php include 'includes/slider.php'; ?>
                           ...
                           <table class="table table-striped">
                              <thead>
                                ...
                                <tr><td>The process for applying and being admitted to Eastern varies somewhat depending on whether you are an entering freshman, a transfer or graduate student, and whether you are a domestic or international student.</td>
                                    ...
                                    <td>30 Days before semester starts.</td>                  
                                    <td>No Fees</td>
                                    <td><a href="http://www.enmu.edu/admission%20/schedule-your-visit">Campus Visits</a></td>
                                </tr>
                            </thead>
                        </table>
                     ...
                     <table class="table table-striped">
                      <thead>
                        ...
                        <tr><td><ul><li>Complete the IAIA Online Application form</li>
                            ...
                            <li>Portfolio</li></ul></td>
                            <td>Students who have successfully completed the equivalent of 24 or more transferable semester credits at other accredited institutions may apply to be admitted as transfer students.</td>
                            <td>Fall Semester: Applications received after August 4 will be reviewed for the following Spring semester.<br />
                                Spring Semester: Applications received after January 4 will be reviewed for the following Fall semester.</td>
                                <td>A non-refundable $25 application fee.</td>
                                <td><a href="https://iaia.wufoo.com/forms/visit-iaia-%20campus/">Campus Visits</a></td>
                            </tr>
                        </thead>
                    </table>
                </div> 
                      ...
                      <thead>
                          ...
                          <tr><td>Start with an admission application, fill out and send with documents or the application itself, but will be pending. The documents are an Official original Certificate of Indian Blood, an official high school transcript or official GED test scores in a sealed envelope and if you attended any other college or university, an Official transcript in a sealed envelope. Once the application and ALL documents are received, you will receive an official letter of acceptance to the college.</td>
                            <td><ul><li>A completed and signed NTU
                                Application</li><li>All Native American students are required to submit a Certificate of Indian
                                Blood (CIB) or an official record of enrollment that indicates membership of a federally recognized
                                Indian Tribe.</li><li>An OFFICIAL high school transcript or OFFICIAL General Education Development
                                (GED) test results</li><li>Official college transcripts from each college attended, indicating all
                                courses taken</li><li>For students who are transferring or have taken prior college courses:
                                Official college transcripts</li></ul></td>
                                <td>If you’re applying as a freshman it is best to get it
                     ...
                     <table class="table table-striped">
                      <thead>
                          ...
                          <tr><td><ul><li>Must submit a formal application for new freshman admission</li><li>Must have graduated high
                            ...
                            (GPA)</li><li>Must submit official high school transcripts</li></ul></td><td><ul><li>An
                            official transcript sent to the Highlands Admissions Office.</li><li>An unofficial or
                            student transcript in your possession when meeting with Highlands’ academic advisers.</li> <li>If
                            you are a New Mexico Lottery Scholarship recipient, request a New Mexico Scholarship Transfer
                            transcript from your current university/ college financial aid office and have it sent to the
              ...
              <table class="table table-striped">
                  <thead>
                      ...
                      <tr><td>You are eligible
                        ...
                        minimum high school course requirements listed below and meet one of the following GPA (grade point
                        average)/test score requirements.</td><td>A 2.0 or above cumulative GPA in your college courses and
                        30 completed credit hours. If you have fewer than 30 complete college credit hours, you must fulfill
                        the First Time Freshmen admission.</td><td>University Admissions encourages the applicant to apply
                        by March 15th for fall enrollment and by October 15th for spring enrollment to be considered for
                        financial support. </td><td>The application fee is $20 and nonrefundable.</td><td><a
                        href="http://admissions.nmsu.edu/visit/">Campus Visits</a></td></tr> 
                    </thead>
                </table>
            </div> 
        </tr>
              ...
              <table class="table table-striped">
                  <thead>
                      ...
                      <tr><td><ul><li>A
                        ...
                        score (Critical Reading and Math)</li> <li>Complete an Application for Undergraduate Admission and
                        Scholarship</li> <li>Official high school transcript or official GED scores. Home schooled students
                        must provide documentation of courses completed.</li>                 <li>Official college
                        transcript(s) from ALL colleges attended (if applicable).</li>                 <li>Official ACT
                        Student Profile Report or SAT College Report.</li></ul></td><td>Eligibility</td><td>To be assured of
              ...
              <table class="table table-striped">
                  <thead>
                      ...
                      <tr><td>Students
                        ...
                        average (2.0 on a 4.0 scale) in all transferrable college work attempted. Students applying for
                        admission to UNM with fewer than 24 transferrable credit hours must meet both transfer and freshmen
                        admission requirements.</td><td>At least 24 transferrable credits must have at least a “C” average.
                        If fewer than 24 transferrable credits, please send official high school transcripts (or GED scores)
                        and ACT/SAT scores to UNM.</td><td>For priority consideration, apply by the following dates: Fall -
                        June 15; Spring - November 15; Summer - May 1.</td><td>For priority consideration, apply by the
                        following dates: Fall - June 15; Spring - November 15; Summer - May 1.</td><td><a href="">Campus
                        Visits</a></td></tr>
                    </thead>
                </table>
            </div> 
              ...
              <thead>
                  ...
                  <tr><td>Applying to WNMU is easy and can be done quickly.<br />
                    <ul><li>Apply for Admissions</li><li>Provide official high school
                        transcripts or GED scores.</li> <li>Provide ACT or SAT scores.</li> <li>Complete the FAFSA
                        Application</li><li>Apply for scholrships.</li>
              ...
              <thead>
                  ...
                  <tr><td><li>A completed Diné College admission application.</li> <li>Official
                    ...
                    <li>Transfer students must provide official transcripts from all colleges and universities
                        previously attended.</li><li>All Arizona students are encouraged to
                        either complete the Arizona Health Care Cost Containment System (AHCCCS) forms with the Arizona
              ...
              <table class="table table-striped">
                  ...
                  <tr><td><a href="http://www.roswell.enmu.edu/admissions-home">Admissions</a></td></tr>
                    ...
                    <tr><td>ENMU-Roswell has an open admissions policy. All you need is a high school diploma
                        ...
                        each college or university attended. Students with fewer than 30 semester hours of acceptable
                        transfer credit must also have official high school transcripts sent. </td><td>In order to allow
              ...
              <table class="table table-striped">
                  <thead>
                      ...
                      <tr><td>Degree Seeking Requirements: <br /><ol type="1"><li>An application for admission.</li><li>An official high school or GED transcript verifying graduation.</li> <li>Official transcripts from all previously attended colleges or universities.</li></ol></td><td>Transfer students from other colleges or universities may be admitted to ENMU-Ruidoso. Requirements for admission as a transfer student
                        ...
                        <li>Transfer students from other colleges or universities must submit a degree-seeking (regular)
                            application, and official transcripts from all colleges previously attended.</li> <li>An official
                            copy of their high school or HSE transcript. However, this will be waived if a student transfers 30
                            credit hours from another institution.</li></ul> </td><td>ENMU- Ruidoso has an open admissions
                            policy, applicants may be admitted to ENMU-Ruidoso as long as the applicant has either graduated
                            from high school or obtained an equivalency, or enrolled in the Early College Program, or are non-
                            degree seeking and 18 years of age or older.</td><td>Applying to ENMU is free.</td><td>Come feel the
                            spirit of Eastern, first- hand. Be our guest for a guided tour of the campus with our President’s
                            Ambassadors.</td></tr> 
                        </thead>
                    </table>
                </div> 
                  ...
                  <table class="table table-striped">
                      <thead>
                          ...
                          <tr><td>Luna Community College is an open-admission,
                            ...
                            /> <ul><li>Apply for Admission</li> <li>Advisement</li> <li>ACT/Compass</li></ul></td><td>LCC
                            accepts transfer of academic credits earned from regionally accredited institutions of higher
                            learning.</td><td>Can be admitted at any time.</td><td>No admissions fees.</td><td><a
                      ...
                      <thead>
                          ...
                          <tr><td><ol type="1"><li>Complete an online admissions application -</li>
                            <li>Official high school transcripts or a GED confirming high school graduation are to be sent
                                directly to the College. Students who have attended another college or university should request
                                official transcripts from each institution.</li> <li>Complete placement exam Students must take the
                                placement exam, ACT scores are accepted in lieu of the College’s placement exam</li>
                                <li>Meet with an academic advisor Please contact the Student Affairs Office at (575) 461-4413, ext.
                                    153.</li> <li>Register for classes After meeting with an Academic Advisor students will be able to
                                    register for classes.</li> <li>Apply for Financial Aid Pay tutition and fees</li></ol>
                                </td><td>Mesalands Community College adheres to an open admissions policy; admitting any student to
                      ...
                      <table class="table table-striped">
                          <thead>
                              ...
                              <tr><td>Whether you're a first-
                                ...
                                are taking classes to upgrade your job skills, New Mexico Junior College can help you achieve your
                                goals. In addition, we offer dual credit and concurrent enrollment to high school students. Complete
                                the Online Application and allow two (2) business days for processing from the date of submission
                                online (please be sure to hit submit & then log off).</td><td>
                                <ol type="1"><li>Complete the application to NMJC. An application is available online at
                                    www.nmjc.edu, or one can be obtained from Admissions. There is no application fee.</li> <li>Submit
                                    an official high school transcript(s), showing date of graduation. Students earning the high school
                                    equivalent certificate must submit proof of successful test completion.</li> <li>Submit college
                                    transcript(s). (Transfer students must submit current, official transcripts of all previous college
                                    attendance. Transfer students must also submit high school transcripts.)</li> <li>Provide placement
                                    / assessment exam scores. Submit ACT or SAT scores and / or placement scores if
                                    available.</li></ol></td><td>Application Deadlines for International Students:<br />

                                    <ul><li>May 1: Fall Semester
                                        (August)</li> <li>September 1: Spring Semester (January)</li> <li>February 1: Summer Session
                                        (June)</li></ul></td><td>No application fee.</td><td>Prospective students are encouraged to visit
                                        the campus. Arrangements for visits that will include a full exploration of college life can be made
                              ...
                              <table class="table table-striped">
                                  <thead>
                                    ...
                                    <tr><td>Junior college
                                        ...
                                        and transcripts for any college work. </td><td>Applicant must be:<br />
                                        <ul><li>be under 22
                                            years of age</li> <li>never have been married</li> <li>have no dependent children</li> <li>be in
                                            good physical condition</li> <li>able to participate in athletic and leadership development
                                            activities</li> <li>have no major disciplinary and/or drug or alcohol abuse
                                            problems</li></ul></td><td>Priority deadline is March 1.</td><td>Application is free of
                                            charge.</td><td>Tours are generally available Monday through Friday at 8 a.m. and 1 p.m. Please
                                            contact the Admissions Office for further details or to schedule your visit. We also host several
                                            Open House events on Saturdays.<br /> <a
