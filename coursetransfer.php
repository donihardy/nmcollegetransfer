            ...
            <tbody>
                ...
                <td class="hiddenRow">
                  <div class="accordian-body collapse" id="enmu"> 
                   <table class="table table-striped">
                    <thead>
                      <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Request for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
              ...
              <tr>
                <td class="hiddenRow"><div class="accordian-body collapse" id="iaia"> 
                  <table class="table table-striped">
                    <thead>
                      <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
            ...
            <tr>
              <td class="hiddenRow"><div class="accordian-body collapse" id="enmurui"> 
                <table class="table table-striped">
                  <thead>
                    <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                    <tr><td>Official Transcripts are those sent directly by an official from previously attended schools to ENMU-Ruidoso Student Services.</td><td>New Mexico’s colleges and universities have collaborated to produce guides to assist students who plan to transfer before completing a program of study. Course modules are designed to help students select courses carefully so that they may transfer with little or no loss of credit.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td><p>Students can use their ACT score for placement when enrolling into classes. Students will need to bring in a copy of their ACT scores to Student Services.</p>
                      <p>Student has appropriate ACT (Eng 18, Read 17, Math 23) / SAT (Verb 440, Math 460) scores.</p></td><td>Request info via email:<br />
                      <a href="mailto:ruidosoadvising@enmu.edu">Email</a></td><td>No agreements found.</td><td>The Dual Credit is a program in which qualified highschool students can take college level courses and earn high school and college credit while tuition cost is waived by ENMU-Ruidoso.</td></tr>
                      </thead>
                    </table>
                  </div>
                  </td> 
                ...
                <tr>
                  <td class="hiddenRow"><div class="accordian-body collapse" id="luna"> 
                    <table class="table table-striped">
                      <thead>
                        <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                        <tr><td>Official Transcripts must be sent to the Office of the Registrar.</td><td>Students will receive full credit for course work completed with a grade of "C" or better, provided that the courses are appropriate toward a certificate or degree.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td><p>A minimum English ACT score of 19, minimum Writing placement score of 70 or ENG098: Essentials of College Writing</p>
                    ...
                    <tr>
                      <td class="hiddenRow"><div class="accordian-body collapse" id="nmjc"> 
                        <table class="table table-striped">
                          <thead>
                            <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                            <tr><td>Transfer students must submit official transcripts from all colleges / universities attended for possible transfer credit. Transcripts should be sent immediately following the close of the last semester of attendance at other colleges.</td><td><a href="http://www.nmjc.edu/assets/documents/Transfer%20Equivalency%20Table.pdf">Transfer Equivalency Table</a></td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td> If you have taken the ACT or SAT, you can use those scores as placement data.<br />
                              ACT Code: 2643<br />
                        ...
                        <tr>
                          <td class="hiddenRow"><div class="accordian-body collapse" id="nmmi"> 
                            <table class="table table-striped">
                              <thead>
                                <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                                <tr><td>All applicants may send partial/unofficial transcripts or report cards to expedite the admissions process and then have official transcripts sent at the completion of the current semester.</td><td>Transfer credits are applicable if the student is able to pass a validation test for the class at the academy.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td>No information found.</td><td>Phone:<br /> <a href="tel:1-575-622-6250">(575) 622-6250</a><br />
                      ...
                      <tr>
                        <td class="hiddenRow"><div class="accordian-body collapse" id="nmsua"> 
                          <table class="table table-striped">
                            <thead>
                              <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                              <tr><td>All transcripts must be sent directly to the NMSU-A Admissions & Records Office by the Registrar of each institution attended. A student who conceals the fact that he/she has attended another college or university and who does not have the Registrar submit a transcript for each institution, whether or not credit was earned, will be subject to immediate suspension.</td><td>To facilitate the transfer of courses within certain degree programs, New Mexico colleges and universities have collaborated to develop transferable discipline modules.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td>No information found.</td><td>Contact the NMSU Registrar’s Office at:<br /> <a href="tel:1-575-646-3411">(575) 646-3411</a><br /> or <a href="mailto:registra@nmsu.edu">registra@nmsu.edu.</a></td><td>No agreements found.</td><td>Dual Credit is a statewide sponsored program for eligible High School Students in which they can receive high school credit for taking approved college courses.
                              </td></tr>
                            </thead>
                          </table>
                        </div>
                      ...
                      <tr>
                        <td class="hiddenRow"><div class="accordian-body collapse" id="nmsud"> 
                          <table class="table table-striped">
                            <thead>
                              <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                              <tr><td>Request official High School transcripts or GED test scores and college transcripts (if applicable) from each educational institution attended. All official transcripts must be mailed directly to DACC Office of Admissions by the records/registrar's office of the issuing institution(s).</td><td>Credits from accredited postsecondary institutions are automatically evaluated after official transcripts are received by the DACC Admissions Office. A transfer student may, on the basis of an evaluation of her/his transcripts, receive credit for courses taken at other postsecondary institutions in which a grade of D or higher was received.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td><p>ACT/SAT scores that are less than 2 years old may be accepted in lieu of the COMPASS assessment and it is not required for you to take the assessment.</p>
                          ...
                          <tr>
                            <td class="hiddenRow"><div class="accordian-body collapse" id="unmg"> 
                              <table class="table table-striped">
                                <thead>
                                 <tr><td class="schoolname">Transcripts:</td><td class="schoolname">Transferable Courses:</td><td class="schoolname">Common Core:</td> <td class="schoolname">ACT/SAT:</td><td class="schoolname">Rquest for Info:</td><td class="schoolname">Agreements:</td><td class="schoolname">Dual Enrollment:</td></tr>
                                 <tr><td>To receive transfer credit from previous institutions, official transcripts from those institutions must be mailed directly to UNM Gallup Office of Admissions. A transfer evaluation, reflecting those transfer credits acceptable at UNM, will be generated only after the student is officially admitted to a degree program at UNM Gallup or UNM Albuquerque.</td><td>Students intending to go to the Albuquerque campus to pursue a four-year degree should be aware that many of the necessary prerequisites for Albuquerque campus degree programs are offered at UNM Gallup. Students are cautioned that courses listed with an * (e.g., BSTC 232*) are considered to be technical/vocational courses and are not acceptable for transfer to baccalaureate programs except by petition to, and acceptance from, a UNM degree-granting program.</td><td>NM Common core is transferable to all NM Schools.<br /><a href="nmcommoncore.php">NM Common Core</a></td><td>ACT or SAT scores for Math & English Placement</td><td>Phone:<br /> <a href="tel:1-505-863-7524">(505) 863-7524</a></td><td><a href="http://admissions.unm.edu/future_students/branch-transition.html">Branch Transitions</a></td><td>Dual credit is a program which provides public high school students the opportunity to receive credit for both high school and
